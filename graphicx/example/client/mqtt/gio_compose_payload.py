from graphicx.example.nexocraft.wireformat import Timeseries

import graphicx.example.nexocraft.wireformat
...
def compose_payload(now, ts_values):
    ...
    with graphicx.example.nexocraft.wireformat.compose_batch() as batch:
